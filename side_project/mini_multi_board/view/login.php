...
<body class="vh-100 vw-100">
	...
	<main class="d-flex justify-content-center align-items-center h-75">
		<form action="/board/list" style="width: 300px;"> <!--자유 게시판으로 이동-->
			<div id="errorMsg" class="form-text text-danger">에러에러</div>
			<div class="mb-1">
			  ...
			  <div class="input-group flex-nowrap">
				...
				<input type="text" class="form-control" placeholder="ID" aria-label="Username" aria-describedby="addon-wrapping" id="u_id">
			</div>
		</div>
		<div class="mb-3">
			...
			<div class="input-group flex-nowrap">
				...
				<input type="password" class="form-control" placeholder="PW" aria-label="Username" aria-describedby="addon-wrapping" id="u_pw">
			  </div>
			</div>
			<button type="submit" class="btn btn-info text-center" style="width: 300px;">Log In</button>
		</form>
	</main>
